...
const Banner = () => {
  return (
    <div className='h-screen flex flex-col justify-center items-center uppercase px-5 bg-gradient-to-b from-gray-800 via-gray-900 to-green-900 font-semibold text-gray-100'>
      <div>
        ...
        <div className='flex justify-items-start gap-6 pt-12 text-4xl'>
          <a href='https://github.com/iamsdas' aria-label='github'>
            <i
              className='fab fa-github hover:text-gray-400'
              aria-hidden='true'></i>
          </a>
          <a href='https://gitlab.gnome.org/iamsdas' aria-label='gitlab'>
            <i
              className='fab fa-gitlab hover:text-gray-400'
              aria-hidden='true'></i>
          </a>
          <a href='mailto:suryashankardas.2002@gmail.com' aria-label='email'>
            <i
              className='fa fa-envelope hover:text-gray-400'
              aria-hidden='true'></i>
          </a>
