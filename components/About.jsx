...
const About = () => {
  return (
    <div className='py-8 flex md:flex-row flex-col-reverse bg-gray-100 items-center'>
      <div className='text-green-700 md:w-1/2 px-5'>
        <h1 className='text-4xl pb-4 font-medium uppercase'>About Me</h1>
        <div className='leading-normal sm:leading-relaxed md:text-2xl sm:text-xl text-lg text-left text-gray-800'>
