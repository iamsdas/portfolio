  ...
  return (
    <section className='bg-trueGray-800'>
      <div className='px-5 py-12 space-y-4 md:w-2/3 mx-auto border-t-2 border-trueGray-700 border-dashed border-opacity-75'>
        ...
        <div className='text-xl sm:text-2xl text-trueGray-300 font-para leading-relaxed text-left sm:text-justify pb-9'>
        ...
        <div className='flex flex-wrap justify-center items-center gap-6 sm:gap-10 md:gap-12'>
          {skills.map(({ name, url }, index) => (
            <div
              className='rounded-full p-4 md:p-5 w-24 sm:w-32 h-24 sm:h-32 bg-gray-50 justify-center items-center flex shadow-xl
              filter hover:blur'
              key={index}>
